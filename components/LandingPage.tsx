      ...
      <nav className="border-b border-slate-800/60 backdrop-blur-md fixed w-full z-50 bg-slate-950/80">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="text-slate-400 hover:text-white font-medium text-sm transition-colors hidden sm:block">
              Pricing
            </button>
            <Button
              onClick={onLogin}
      ...
      <div className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Upload any static image and let our advanced Veo models generate
            cinematic videos in seconds. The complete platform for creators and
            agencies.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 flex-wrap">
            <Button
              onClick={onLogin}
              isLoading={isLoading}
              className="!text-lg !px-8 !py-4 shadow-xl shadow-purple-500/25"
            >
              Get Started with Google
            </Button>
          </div>

          <div className="mt-20 relative mx-auto max-w-5xl h-64" />
        </div>
      </div>
